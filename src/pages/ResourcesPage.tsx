  ...
  return (
    <>
      ...
      <Section background="secondary" className="text-white">
        <div className="text-center mb-12">
          <h2 className="text-2xl md:text-3xl font-bold mb-4">Submit a Resource</h2>
          <p className="text-white/80 max-w-2xl mx-auto">
            Are you a researcher or practitioner with valuable resources to share? Submit your work for review 
            and potential inclusion in our resource library.
          </p>
        </div>
        
        <div className="max-w-xl mx-auto">
          <form className="bg-white/10 backdrop-blur-sm p-6 rounded-lg border border-white/20">
            <div className="mb-4">
              <label className="block text-sm font-medium mb-1" htmlFor="resourceTitle">Resource Title*</label>
              <input 
                id="resourceTitle"
                type="text" 
                className="w-full px-4 py-2 bg-white/20 border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-400 text-white placeholder-white/60"
                placeholder="Enter the title of your resource"
              />
            </div>
            
            <div className="mb-4">
              <label className="block text-sm font-medium mb-1" htmlFor="resourceType">Resource Type*</label>
              <select 
                id="resourceType"
                className="w-full px-4 py-2 bg-white/20 border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-400 text-white"
              >
                <option value="">Select resource type</option>
                <option value="publication">Research Publication</option>
                <option value="guide">Clinical Guide</option>
                <option value="protocol">Protocol</option>
                <option value="tool">Assessment Tool</option>
                <option value="other">Other</option>
              </select>
            </div>
            
            <div className="mb-4">
              <label className="block text-sm font-medium mb-1" htmlFor="authors">Authors*</label>
              <input 
                id="authors"
                type="text" 
                className="w-full px-4 py-2 bg-white/20 border border-white/30 rounded-md focus:outline-none focus:ring-2 focus:ring-accent-400 text-white placeholder-white/60"
            ...
            <div className="mb-6">
              ...
              <div className="border border-dashed border-white/40 rounded-md p-4 text-center">
                <label className="cursor-pointer">
                  <div className="flex flex-col items-center justify-center">
                    <Download className="h-8 w-8 mb-2" />
                    <span className="text-sm font-medium">Click to upload or drag and drop</span>
                    <span className="text-xs text-white/70">PDF, DOCX, PPTX (max 10MB)</span>
                  </div>
            ...
            <Button type="submit" variant="accent" className="w-full text-primary-900">
              Submit Resource
            </Button>
          </form>
        </div>
